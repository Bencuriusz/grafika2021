...
void init_entities(World *world)
{
    ...
    //Model
    load_model("models//H&K USP 45 Game.obj", &world->gun.model);
    //load_model("models//m4a1.obj", &world->gun.model);
    world->gun.texture = load_texture("textures//handgun_C.jpg");
    scale_model(&world->gun.model, 0.3, 0.3, 0.3);
    init_object(&world->gun, 150, 150);
